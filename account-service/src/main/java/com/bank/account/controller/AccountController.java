...
public class AccountController {
	...
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<AccountResponse> getById(@PathVariable("accountId") UUID accountId) {
	...
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<AccountResponse> update(@PathVariable("accountId") UUID accountId,
	...
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<Void> close(@PathVariable("accountId") UUID accountId) {
	...
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<Void> creditById(@PathVariable("accountId") UUID accountId,
	...
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<Void> debitByAccountNumber(@PathVariable("accountNumber") String accountNumber,
			@RequestBody java.math.BigDecimal amount) {
	...
	@PreAuthorize("isAuthenticated()")
	public ResponseEntity<Void> creditByAccountNumber(@PathVariable("accountNumber") String accountNumber,
			@RequestBody java.math.BigDecimal amount) {
